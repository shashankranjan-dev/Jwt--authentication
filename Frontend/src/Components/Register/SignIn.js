...
function SignIn() {
  ...
  return (
    <div>
      <div class="min-h-full  text-gray-900 flex justify-center">
        <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-6">
            <div>
              <h1 class="text-2xl w-20 mx-auto xl:text-2xl font-semibold">
                Skygoal
              </h1>
            </div>
              ...
              <div class="w-full flex-1 mt-8">
                ...
                <div class="mx-auto max-w-xs">
                  ...
                  <p class="mt-6 text-xs text-gray-600 text-center">
                    ...
                    and its
                    <a href="1#" class="border-b border-gray-500 border-dotted">
                      Privacy Policy
                    </a>
                  </p>
                </div>
